...
export const products: Product[] = [
  ...
  // ── NEW HOODIES (7-10) ──
  {
    id: "7", productId: "MG-007", name: "Phantom Zip-Up Hoodie", price: 3999, image: productHoodie1, category: "hoodies",
    sizes: ["S", "M", "L", "XL"], colors: defaultColors,
  ...
  {
    id: "8", productId: "MG-008", name: "Midnight Velour Hoodie", price: 4499, image: productHoodie2, category: "hoodies", badge: "Premium",
    sizes: ["S", "M", "L", "XL"], colors: defaultColors,
  ...
  {
    id: "9", productId: "MG-009", name: "Arctic Fleece Hoodie", price: 4299, image: productHoodie3, category: "hoodies",
    sizes: ["S", "M", "L", "XL"], colors: defaultColors,
  ...
  {
    id: "10", productId: "MG-010", name: "Shadow Pullover Hoodie", price: 3699, image: productHoodie1, category: "hoodies",
    sizes: ["S", "M", "L", "XL"], colors: defaultColors,
  ...
  // ── NEW T-SHIRTS (11-16) ──
  {
    id: "11", productId: "MG-011", name: "Concrete Jungle Tee", price: 1799, image: productTee1, category: "tshirts",
    sizes: ["S", "M", "L", "XL"], colors: teeColors,
  ...
  {
    id: "12", productId: "MG-012", name: "Noir Essential Tee", price: 1499, image: productTee2, category: "tshirts",
    sizes: ["S", "M", "L", "XL"], colors: teeColors,
  ...
  {
    id: "13", productId: "MG-013", name: "Washed Slate Tee", price: 1699, image: productTee3, category: "tshirts",
    sizes: ["S", "M", "L", "XL"], colors: teeColors,
  ...
  {
    id: "14", productId: "MG-014", name: "Midnight Stripe Tee", price: 1899, image: productTee1, category: "tshirts", badge: "New",
    sizes: ["S", "M", "L", "XL"], colors: teeColors,
  ...
  {
    id: "15", productId: "MG-015", name: "Graffiti Tag Tee", price: 1999, image: productTee2, category: "tshirts",
    sizes: ["S", "M", "L", "XL"], colors: teeColors,
  ...
  {
    id: "16", productId: "MG-016", name: "Raw Edge Longline Tee", price: 1799, image: productTee3, category: "tshirts",
    sizes: ["S", "M", "L", "XL"], colors: teeColors,
  ...
  // ── SWEATSHIRTS (17-22) ──
  {
    id: "17", productId: "MG-017", name: "Oversized Crew Sweatshirt", price: 3299, image: productHoodie1, category: "sweatshirts", badge: "Best Seller",
    sizes: ["S", "M", "L", "XL"], colors: defaultColors,
  ...
  {
    id: "18", productId: "MG-018", name: "Vintage Wash Sweatshirt", price: 3499, image: productHoodie2, category: "sweatshirts",
    sizes: ["S", "M", "L", "XL"], colors: defaultColors,
  ...
  {
    id: "19", productId: "MG-019", name: "Tech Fleece Crewneck", price: 3799, image: productHoodie3, category: "sweatshirts", badge: "New",
    sizes: ["S", "M", "L", "XL"], colors: defaultColors,
  ...
  {
    id: "20", productId: "MG-020", name: "Distressed Edge Sweatshirt", price: 3599, image: productHoodie1, category: "sweatshirts",
    sizes: ["S", "M", "L", "XL"], colors: defaultColors,
  ...
  {
    id: "21", productId: "MG-021", name: "Colorblock Crew Sweatshirt", price: 3399, image: productHoodie2, category: "sweatshirts",
    sizes: ["S", "M", "L", "XL"], colors: defaultColors,
    material: "80% Cotton, 20% Polyester — 320 GSM, Stitched in Pakistan",
  ...
  {
    id: "22", productId: "MG-022", name: "Embossed Logo Sweatshirt", price: 3699, image: productHoodie3, category: "sweatshirts", badge: "Premium",
    sizes: ["S", "M", "L", "XL"], colors: defaultColors,
  ...
  // ── JACKETS (23-28) ──
  {
    id: "23", productId: "MG-023", name: "Urban Bomber Jacket", price: 4999, image: productHoodie1, category: "jackets", badge: "Best Seller",
  ...
  {
    id: "24", productId: "MG-024", name: "Stealth Windbreaker", price: 4499, image: productHoodie2, category: "jackets", badge: "New",
    sizes: ["S", "M", "L", "XL"], colors: jacketColors,
  ...
  {
    id: "25", productId: "MG-025", name: "Cargo Utility Jacket", price: 4799, image: productHoodie3, category: "jackets",
    sizes: ["S", "M", "L", "XL"], colors: jacketColors,
  ...
  {
    id: "26", productId: "MG-026", name: "Puffer Street Jacket", price: 4999, image: productHoodie1, category: "jackets", badge: "Premium",
    sizes: ["S", "M", "L", "XL"], colors: jacketColors,
  ...
  {
    id: "27", productId: "MG-027", name: "Denim Trucker Jacket", price: 4599, image: productHoodie2, category: "jackets",
    sizes: ["S", "M", "L", "XL"], colors: jacketColors,
  ...
  {
    id: "28", productId: "MG-028", name: "Tech Shell Jacket", price: 4699, image: productHoodie3, category: "jackets",
    sizes: ["S", "M", "L", "XL"], colors: jacketColors,
  ...
  // ── STREETWEAR SETS (29-34) ──
  {
    id: "29", productId: "MG-029", name: "Shadow Tracksuit Set", price: 4999, image: productHoodie1, category: "streetwear-sets", badge: "Best Seller",
  ...
  {
    id: "30", productId: "MG-030", name: "Velour Lounge Set", price: 4799, image: productHoodie2, category: "streetwear-sets", badge: "Premium",
    sizes: ["S", "M", "L", "XL"], colors: setColors,
  ...
  {
    id: "31", productId: "MG-031", name: "Tech Fleece Combo", price: 4999, image: productHoodie3, category: "streetwear-sets",
    sizes: ["S", "M", "L", "XL"], colors: setColors,
    material: "Cotton-Poly Tech Fleece — 340 GSM, Stitched in Pakistan",
  ...
  {
    id: "32", productId: "MG-032", name: "Cargo Duo Set", price: 4899, image: productHoodie1, category: "streetwear-sets", badge: "New",
    sizes: ["S", "M", "L", "XL"], colors: setColors,
  ...
  {
    id: "33", productId: "MG-033", name: "Monochrome Zip Set", price: 4699, image: productHoodie2, category: "streetwear-sets",
    sizes: ["S", "M", "L", "XL"], colors: setColors,
  ...
  {
    id: "34", productId: "MG-034", name: "Urban Runner Set", price: 4599, image: productHoodie3, category: "streetwear-sets",
    sizes: ["S", "M", "L", "XL"], colors: setColors,
  ...
  // ── Extra Jackets/Sweatshirts ──
  {
    id: "35", productId: "MG-035", name: "Distressed Denim Jacket", price: 4899, image: productHoodie1, category: "jackets",
    sizes: ["S", "M", "L", "XL"], colors: jacketColors,
  ...
  {
    id: "36", productId: "MG-036", name: "Essential Crewneck Sweatshirt", price: 2999, image: productHoodie3, category: "sweatshirts",
    sizes: ["S", "M", "L", "XL"], colors: defaultColors,
  ...
  // ── SHIRTS (37-42) ──
  {
    id: "37", productId: "MG-037", name: "Premium Oxford Shirt", price: 2999, image: productTee1, category: "shirts", badge: "New",
  ...
  {
    id: "38", productId: "MG-038", name: "Urban Linen Shirt", price: 3299, image: productTee2, category: "shirts",
    sizes: ["S", "M", "L", "XL"], colors: shirtColors,
  ...
  {
    id: "39", productId: "MG-039", name: "Midnight Satin Shirt", price: 3499, image: productTee3, category: "shirts", badge: "Premium",
    sizes: ["S", "M", "L", "XL"], colors: shirtColors,
  ...
  {
    id: "40", productId: "MG-040", name: "Flannel Check Shirt", price: 2799, image: productTee1, category: "shirts",
    sizes: ["S", "M", "L", "XL"], colors: shirtColors,
  ...
  {
    id: "41", productId: "MG-041", name: "Corduroy Overshirt", price: 3699, image: productTee2, category: "shirts", badge: "Best Seller",
    sizes: ["S", "M", "L", "XL"], colors: shirtColors,
  ...
  {
    id: "42", productId: "MG-042", name: "Twill Utility Shirt", price: 2899, image: productTee3, category: "shirts",
    sizes: ["S", "M", "L", "XL"], colors: shirtColors,
